...
const Select = ({children, label, ...rest}: {children: React.ReactNode, label?: React.ReactNode} & SelectPrimitive.SelectProps) => {
  return (
    <label className="flex items-start gap-1 justify-center flex-col">
